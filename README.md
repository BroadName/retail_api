...
- Обновление контактной и личной информации
...
### Использование
Для взаимодействия с API проекта:
- воспользоваться веб-интерфейсом DRF или отправка запросов по адресу http://127.0.0.1:8000/api/v1/;
- воспользоваться Postman для API-запросов;

### Примеры запросов:

- Для загрузки товаров из файла необходимо отправить POST-запрос на адрес http://127.0.0.1:8000/api/v1/upload/ с прямой ссылкой на файл с товарами.
```
